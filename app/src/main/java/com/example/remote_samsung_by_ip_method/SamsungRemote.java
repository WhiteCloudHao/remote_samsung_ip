...
import com.example.remote_samsung_by_ip_method.utils.Aleart;
...
//    private final char[] SKIP = {0x0a, 0x00, 0x01, 0x00, 0x00, 0x00}; // Don't know yet what this means, seems like keep-alive, I skip them.
     ...
     */
    public SamsungRemote(InetAddress host, MainActivity mainActivity) throws IOException {
        this(host, false);
    ...
    public SamsungRemote(InetAddress host, boolean debug) throws IOException {
        ...
        try {
            ...
            Aleart.showAlert(mainActivity,"success connect socket");
        } catch (IOException e) {
            Aleart.showAlert(mainActivity,"fail connect socket");
        }
     ...
     * @see SamsungRemote#authenticate(String, String,
     * String) authenticate
     */
    public TVReply authenticate(String name) throws IOException {
        String hostAddress = socket.getLocalAddress().getHostAddress();
        Aleart.showAlert(mainActivity, "start authenticate, " + hostAddress);
